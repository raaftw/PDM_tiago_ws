...
static const _GetMotionInfo_Request_type_support_symbol_names_t _GetMotionInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, play_motion2_msgs, srv, GetMotionInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, play_motion2_msgs, srv, GetMotionInfo_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, play_motion2_msgs, srv, GetMotionInfo_Request)() {
  return &::play_motion2_msgs::srv::rosidl_typesupport_c::GetMotionInfo_Request_message_type_support_handle;
}
...
static const _GetMotionInfo_Response_type_support_symbol_names_t _GetMotionInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, play_motion2_msgs, srv, GetMotionInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, play_motion2_msgs, srv, GetMotionInfo_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, play_motion2_msgs, srv, GetMotionInfo_Response)() {
  return &::play_motion2_msgs::srv::rosidl_typesupport_c::GetMotionInfo_Response_message_type_support_handle;
}
...
static const _GetMotionInfo_type_support_symbol_names_t _GetMotionInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, play_motion2_msgs, srv, GetMotionInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, play_motion2_msgs, srv, GetMotionInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, play_motion2_msgs, srv, GetMotionInfo)() {
  return &::play_motion2_msgs::srv::rosidl_typesupport_c::GetMotionInfo_service_type_support_handle;
}
