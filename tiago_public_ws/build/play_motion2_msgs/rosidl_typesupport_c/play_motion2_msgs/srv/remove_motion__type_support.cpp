...
static const _RemoveMotion_Request_type_support_symbol_names_t _RemoveMotion_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, play_motion2_msgs, srv, RemoveMotion_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, play_motion2_msgs, srv, RemoveMotion_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, play_motion2_msgs, srv, RemoveMotion_Request)() {
  return &::play_motion2_msgs::srv::rosidl_typesupport_c::RemoveMotion_Request_message_type_support_handle;
}
...
static const _RemoveMotion_Response_type_support_symbol_names_t _RemoveMotion_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, play_motion2_msgs, srv, RemoveMotion_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, play_motion2_msgs, srv, RemoveMotion_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, play_motion2_msgs, srv, RemoveMotion_Response)() {
  return &::play_motion2_msgs::srv::rosidl_typesupport_c::RemoveMotion_Response_message_type_support_handle;
}
...
static const _RemoveMotion_type_support_symbol_names_t _RemoveMotion_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, play_motion2_msgs, srv, RemoveMotion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, play_motion2_msgs, srv, RemoveMotion)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, play_motion2_msgs, srv, RemoveMotion)() {
  return &::play_motion2_msgs::srv::rosidl_typesupport_c::RemoveMotion_service_type_support_handle;
}
